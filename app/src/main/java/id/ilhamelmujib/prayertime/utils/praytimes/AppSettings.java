...
public class AppSettings {
    ...
    public static class Key {
        ...
        public static final String LAST_LOC = "last_loc";
    ...
    public static AppSettings getInstance(Context context) {
        if (sSharedPrefs == null) {
            sSharedPrefs = new AppSettings(context);
        }
        return sSharedPrefs;
    }
    ...
    private String getKeyFor(String key, int index) {
    ...
    int getAsrMethodSetFor(int index) {
    ...
    int getHighLatitudeAdjustmentFor(int index) {
